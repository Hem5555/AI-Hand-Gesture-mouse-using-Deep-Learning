...
keypoint_classifier_labels = ['Open', 'Close', 'Pointer', 'LeftClick', 'RightClick','ScrollDown','ScrollUp']
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                #single click
                if keypoint_classifier_labels[hand_sign_id] == 'RightClick': # if all fingers open gesture for click purpose
                    if not clicked:
